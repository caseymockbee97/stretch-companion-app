export const PrivacyPolicy = () => {
  return (
    <div>
      {privacyPolicy.split('\n').map((each, i) => (
        <p style={{ color: 'black', paddingBottom: '10px' }} key={i}>
          {each}
        </p>
      ))}
    </div>
...
const privacyPolicy = `
Stretch Companion Privacy Policy.
Last updated: June 24, 2024

This Privacy Policy describes how Stretch Companion (the "Site", "we", "us", or "our") collects, uses, and discloses your personal information when you visit, use our services, or make a purchase from verticalscramble.com (the "Site") or otherwise communicate with us (collectively, the "Services"). For purposes of this Privacy Policy, "you" and "your" means you as the user of the Services, whether you are a customer, website visitor, or another individual whose information we have collected pursuant to this Privacy Policy.
...
Should you have any questions about our privacy practices or this Privacy Policy, or if you would like to exercise any of the rights available to you, please call +1 (317) 379-3320 or email us at caseymockbee97@gmail.com or contact us at 596 E Vermont St, Indianapolis, IN, 46202, United States.
`;
